...
if (isset($_SESSION['normal_user']))
	{
	echo '<meta http-equiv="refresh" content="1;url=reading_connect.php">';
	exit;
	}
...
<body onLoad="autoFocus();">
	...
	<p>
		...
		<form name="form" method="post" action=" reading.php" onSubmit="return login_check()"><!--form用來輸入帳號密碼 -->
			<p>
			帳號：<input type="text" name="id" /> <br>
			密碼：<input type="password" name="pw" /> <br><!--input type="password"可隱藏密碼-->
			</p>
